...
type TDQuoteBody struct {
	...
	RtMr0          []byte `protobuf:"bytes,11,opt,name=rt_mr0,json=rtMr0,proto3" json:"rt_mr0,omitempty"`                           // should be 48 bytes
	RtMr1          []byte `protobuf:"bytes,12,opt,name=rt_mr1,json=rtMr1,proto3" json:"rt_mr1,omitempty"`                           // should be 48 bytes
	RtMr2          []byte `protobuf:"bytes,13,opt,name=rt_mr2,json=rtMr2,proto3" json:"rt_mr2,omitempty"`                           // should be 48 bytes
	RtMr3          []byte `protobuf:"bytes,14,opt,name=rt_mr3,json=rtMr3,proto3" json:"rt_mr3,omitempty"`                           // should be 48 bytes
	ReportData     []byte `protobuf:"bytes,15,opt,name=report_data,json=reportData,proto3" json:"report_data,omitempty"`            // should be 64 bytes
}
...
func (x *TDQuoteBody) GetRtMr0() []byte {
	if x != nil {
		return x.RtMr0
	}
	return nil
...
func (x *TDQuoteBody) GetRtMr1() []byte {
	if x != nil {
		return x.RtMr1
	}
	return nil
...
func (x *TDQuoteBody) GetRtMr2() []byte {
	if x != nil {
		return x.RtMr2
	}
	return nil
...
func (x *TDQuoteBody) GetRtMr3() []byte {
	if x != nil {
		return x.RtMr3
	}
	return nil
...
var file_tdx_proto_rawDesc = []byte{
	...
	0x72, 0x44, 0x61, 0x74, 0x61, 0x22, 0xc5, 0x03, 0x0a, 0x0b, 0x54, 0x44, 0x51, 0x75, 0x6f, 0x74,
	...
	,
	...
	0x61, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x67, 0x6f, 0x2d, 0x74, 0x64, 0x78, 0x2d, 0x67, 0x75,
	0x65, 0x73, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x74, 0x64, 0x78, 0x62, 0x06, 0x70,
